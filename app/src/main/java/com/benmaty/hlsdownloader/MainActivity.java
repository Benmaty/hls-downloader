...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDownload.setOnClickListener(v -> {
            ...
            if (url.isEmpty()) {
                status.setText("⚠️ Colle un lien d'abord !");
                return;
            }
            ...
            String cmd = "-user_agent \"Mozilla/5.0 (Linux; Android 13; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36\" " +
            ...
            FFmpegKit.executeAsync(cmd, session -> {
                runOnUiThread(() -> {
                    ...
                    if (ReturnCode.isSuccess(session.getReturnCode())) {
                        ...
                        status.setText("❌ Erreur : " + session.getFailStackTrace());
                    }
                });
            });
        });
